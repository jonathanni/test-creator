	...
	ListSelectionListener
{
    ...
    private JButton editC, addC, remC, moveUpC, moveDownC, editB, addB, remB,
	    moveUpB, moveDownB, editCA, addCA, remCA, moveUpCA, moveDownCA;
    private JList mcChoices, fibBlankList, fibBlankCAChoicesList;
    private DefaultListModel mcCListModel = new DefaultListModel(),
	    fibBlankListModel = new DefaultListModel(),
	    fibCAListModel = new DefaultListModel();

    private final Question question;

    private ArrayList<Choice> mcQChoices = new ArrayList<Choice>();
    private int mcCorrectAnswer, mcChoiceIndex = -1, mcChoiceCount;
	...
	fibBlankCAChoicesList.setModel(fibCAListModel);
